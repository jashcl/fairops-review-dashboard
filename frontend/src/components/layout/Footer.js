  ...
  return (
    ...
    >
      ...
      <Container maxWidth="lg">
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={4}>
            ...
            <Typography variant="body2">
              FairOps helps review teams manage cases, risk signals, evidence checks, reviewer notes, and decision workflows with a clean frontend experience.
            </Typography>
          </Grid>
          ...
          <Grid item xs={12} md={4}>
            ...
            <Box>
              ...
              <Link href="/cases" color="inherit" underline="none" sx={{ display: 'block', marginBottom: '0.5rem', '&:hover': { color: '#f57c00' } }}>
                Review Cases
              </Link>
          ...
          <Grid item xs={12} md={4}>
            ...
            <Typography variant="body2">
              Project Maintainer:{' '}
              <Link href="https://github.com/jashcl" color="inherit" sx={{ textDecoration: 'underline', '&:hover': { color: '#f57c00' } }}>
                Jash Shah
              </Link>
            </Typography>
            <Typography variant="body2">
              Email:{' '}
              <Link href="mailto:jashsujeshshah10@gmail.com" color="inherit" sx={{ textDecoration: 'underline', '&:hover': { color: '#f57c00' } }}>
                jashsujeshshah10@gmail.com
              </Link>
            </Typography>
            <Typography variant="body2">Phone: +91 8433826215</Typography>
          </Grid>
        </Grid>
        ...
        >
          <Typography variant="body2">© {new Date().getFullYear()} FairOps Review Workflow Dashboard. All rights reserved.</Typography>
        </Box>
      </Container>
    </Box>
  );
