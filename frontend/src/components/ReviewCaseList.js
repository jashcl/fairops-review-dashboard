      ...
      <Card>
        ...
        {!visibleCases.length && (
          <Box sx={{ p: 5, textAlign: 'center' }}>
            <Typography variant="h6" sx={{ fontWeight: 800 }}>No cases match these filters</Typography>
            <Typography color="text.secondary">Try clearing one filter or search term.</Typography>
          </Box>
        )}
      </Card>
    </Box>
